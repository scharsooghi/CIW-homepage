...
<div id="layer0">
  ...
  <div align="center">
      ...
      <% If msg=1 Then %>
          <br/><span style="color:#FF0000;">insert is done !! </span><br />   
          <% End If %>
    </div>
  <% If Session("MM_UserAuthorization")=1 or Session("MM_UserAuthorization")=2 or Session("MM_UserAuthorization")=3 Then %>
  <a href="productView.asp">View  all products</a>
  <% End If %>
  <% If Session("MM_UserAuthorization")=1 or Session("MM_UserAuthorization")=2 Then %>
  <a href="productInsert.asp">Add new  product</a>
  <% End If %>
  <% If Session("MM_UserAuthorization")=1 Then %>
  <a href="productEdit_admin.asp">Edit &amp; delete  all products</a>
  <% End If %>
  <% If Session("MM_UserAuthorization")=1 or Session("MM_UserAuthorization")=2 Then %>
  <a href="productEdit_user.asp">Edit &amp; delete your  products</a>
  <% End If %>
  
  <div id="back"><a style="color: #003853; background-color:#CFDCE6; display:inline; padding-right:30px;" href="CPanel.asp">back to CPanel</a></div>
