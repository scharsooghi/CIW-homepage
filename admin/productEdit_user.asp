...
If (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  If (Not MM_abortEdit) Then
    ...
    MM_editRedirectUrl = "productEdit_user.asp"
    If (Request.QueryString <> "") Then
...
%>
<%
Dim Rset_products__MMColParam
Rset_products__MMColParam = "1"
If (Session("MM_Username") <> "") Then 
  Rset_products__MMColParam = Session("MM_Username")
End If
%>
<%
Dim Rset_products
...
Rset_products_cmd.CommandText = "SELECT * FROM dbo.VIEW_prod_place_user WHERE username = ?" 
Rset_products_cmd.Prepared = true
Rset_products_cmd.Parameters.Append Rset_products_cmd.CreateParameter("param1", 200, 1, 50, Rset_products__MMColParam) ' adVarChar
  ...
  <table width="95%" border="1" align="center">
    ...
    <% While ((Repeat1__numRows <> 0) AND (NOT Rset_products.EOF)) %>
      <tr bgcolor="#FFFFFF">
        ...
        <td>          <form id="form2" name="form2" method="get" action="productUpdate_user.asp">
            <div align="center">
